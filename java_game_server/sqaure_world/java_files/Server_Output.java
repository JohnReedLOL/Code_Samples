...
public class Server_Output implements Runnable
{
    ...
    public void run()
    {
        try {
            ...
            if ((object instanceof New_Player_View)) {
                New_Player_View player_view_object2 = (New_Player_View) object;
                Tile_View_Array player_view_object = new Tile_View_Array(player_view_object2.target, player_view_object2.tilesInView);
                String player_name = player_view_object.target;
                ...
                if (temp_info.player_socket != null
                    ...
                    try {
                        ...
                        temp_info.oos.flush();
                        //System.out.println("Player " + player_view_object.target + " was sent a display.");
                        //Dont forget to also update neighbors displays
                    }
